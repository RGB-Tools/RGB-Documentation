...
<figure><img src="../.gitbook/assets/state-passages.webp" alt=""><figcaption><p><strong>Consensus system allows for the tracking of the state evolution of some properties</strong></p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/utxo-set-1.webp" alt=""><figcaption><p><strong>In Bitcoin the System State is represented by the UTXO Set, reflecting the ownership of bitcoins.</strong></p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/blockchain-1.webp" alt=""><figcaption><p><strong>In Public Blockchains everyone needs to validate all the information leading to privacy and scalability issues.</strong></p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/transaction-graph-1.webp" alt=""><figcaption><p><strong>The transaction graph of Public Blockchains cannot be sharded due to internal consistency.</strong></p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/csv-blocks-1.webp" alt=""><figcaption><p><br><strong>Layer 1's blocks are kept public, but client-side validated state transitions are aggregated and committed through suitable merkelization in Layer 1's transactions.</strong></p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/csv-shard-1.webp" alt=""><figcaption><p><strong>Several shards can be aggregated in a single Layer 1 transaction. The Anchor structure establish a link between the client-side data of the contract and the single-use seal.</strong></p></figcaption></figure>
